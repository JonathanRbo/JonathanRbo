...
## 🚀 Sobre Mim
Desenvolvedor **Full Stack** com expertise em **JavaScript, PHP, WordPress**. Especializado em criar soluções web completas e escaláveis, combinando desenvolvimento de ponta com design visual impactante. **Desenvolvedor desde 2023**, formado em Análise e Desenvolvimento de Sistemas pela ETEC Pedro Ferreira Alves.
